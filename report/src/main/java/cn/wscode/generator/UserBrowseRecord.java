package cn.wscode.generator;

import cn.wscode.bean.UserBrowse;
import cn.wscode.send.KafkaMsgSend;
...
public class UserBrowseRecord {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            KafkaMsgSend.send("http://localhost:8888/ReportApplication/retrieveData", jonstr);
        }
    }
}
