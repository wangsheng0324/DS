    ...
    public static class MyFlatMap extends RichFlatMapFunction<Event, String>{
        ...
        public void open(Configuration parameters) throws Exception {
            ...
            myReducingState = getRuntimeContext().getReducingState(new ReducingStateDescriptor<Event>("my-reduce",
                    new ReduceFunction<Event>() {
                        ...
                        public Event reduce(Event value1, Event value2) throws Exception {
                            return new Event(value1.name, value1.url, value2.timestamp);
                        }
                    }
                    , Event.class));
            ...
            StateTtlConfig ttlConfig = StateTtlConfig.newBuilder(Time.hours(1))
                    .setUpdateType(StateTtlConfig.UpdateType.OnReadAndWrite) // 更新类型
        ...
        public void flatMap(Event value, Collector<String> out) throws Exception {
            ...
            myMapState.put(value.name, myMapState.get(value.name) == null? 1: myMapState.get(value.name) + 1);
            System.out.println( "my map value: " + myMapState.get(value.name) );
